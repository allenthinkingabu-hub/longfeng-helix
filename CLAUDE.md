...
- test-cases.md 是用户视角契约 · 用户不签字等于跳过最关键 stakeholder
- audit 强制 ≥ 1 REJECT round 防互相批准 · 但还不够 · 必须真人签字
...
- **Phase 2.5 用户签字必过** · TestDesigner / Coder / Tester 都不准代签 (AI 替签 = 严重越权 + retries++ 熔断)
