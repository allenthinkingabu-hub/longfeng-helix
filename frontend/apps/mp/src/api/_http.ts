...
// @ts-ignore — process/fetch/AbortController available in Node test runtime, not in MP runtime
declare const process: { env: Record<string, string | undefined> };
declare function fetch(input: string, init?: Record<string, unknown>): Promise<{ ok: boolean; status: number; statusText: string; json(): Promise<unknown> }>;
 ...
 *
 * 这层抽象保证 api 业务模块代码相同，pages 真 MP runtime 调真 wx.request，
